...
public class GLVideoRenderer implements GLSurfaceView.Renderer
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        String vertexShader = WlShaderUtil.readRawTxt(context, R.raw.vetext_sharder);
        String fragmentShader = WlShaderUtil.readRawTxt(context, R.raw.fragment_sharder);
        programId = WlShaderUtil.createProgram(vertexShader, fragmentShader);
        ...
        //WlShaderUtil.checkGlError("glBindTexture mTextureID");
   /*GLES11Ext.GL_TEXTURE_EXTERNAL_OES的用处？
    ...
    private void initMediaPlayer() {
        ...
        try {
            AssetFileDescriptor afd = context.getAssets().openFd("v1080.mp4");
